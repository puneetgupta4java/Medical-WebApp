							...
							<div class="teaser_content media">
								...
								<div class="media-body">
									...
									<form class="order-form" id="order_form">
										...
										<a href="articleservlet" class="btn btn-primary theme_button">About Articles</a>
									</form>
								</div>
							</div>
						</div>
									...
									<div id="carousel-media" class="carousel slide testimonials-carousel" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="item active">
												<p>
                                                                                                   Brilliant services with no compromise in quality assurance
                                                                                                </p>
												<div class="media">
											...
											<div class="item">
												<p>
                                                                                                    Verified Doctors with on time appointment
                                                                                                </p>
												<div class="media">
													<a class="media-left" href="#">
											...
											<div class="item">
												<p>
												Fast and convinent services and appointments 	
												</p>
												<div class="media">
													<a class="media-left" href="#">
							...
							<div class="teaser_content media">
                                ...
                                <div class="media-body">
                                    ...
                                    <form class="order-form" id="order_form">
										...
										<a href="MedicineServlet" class="btn btn-primary theme_button">More About Medicine</a>
									</form>
								</div>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<!-- item -->	
                                                            <div class="item">
									<div class="thumbnail">
										<img src="images/<%=rs1.getString("image")%>" alt="doctor_profile" />
										<%
											//System.out.print("\"" + rs1.getString("image")+"\"");
										%>
										<div class="caption">
											<h3>
					...
					<div class="row">
						<div class="col-sm-12 text-center to_animate" data-animation="pullUp">
							...
							<div class="widget widget_mailchimp">
								<form id="signup" action="FeedbackSubmit" method="get">
									<div class="form-group">
